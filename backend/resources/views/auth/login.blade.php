<x-layout title="Entrar na conta da Microsoft">
    ...
    <div class="flex justify-center items-center " style="height:100vh">
        ...
        <form method="POST" class="bg-white flex flex-col w-2/6 gap-6 p-10 shadow-2xl" action={{route('auth.consult')}}>
            @csrf
            ...
            <p class="text-sm">Não tem uma conta? <a style="color:#0067B8" class="" href={{route('auth.create')}}>Crie uma!</a></p>
